...
List<Signal> buildSignals(Fund f, List<Fund> peers,
  ...
  String fill(String s) {
    ...
    return s
        ...
        .replaceAll('{min}', f.minInvest != null ? withCommas(f.minInvest!) : '')
        .replaceAll(
            '{fee}', f.mgmtFee != null ? '${f.mgmtFee!.toStringAsFixed(2)}%' : '');
  }
  ...
  final cls =
      peers.where((x) => x.category == f.category && x.currentRate != null);
