...
class HoldingsRepository {
  ...
  Holding? byFund(String fundId) {
    ...
    return v == null ? null : Holding.fromMap(Map<String, dynamic>.from(v as Map));
  }

  Future<void> setBalance(String fundId, String currency, double newBalance) async {
      ...
      await box.put(
        ...
        Holding(
          ...
          transactions: [
            ...
            Txn(amount: delta, type: delta >= 0 ? 'deposit' : 'withdrawal', date: now),
          ],
        ).toMap(),
      );
    }
